...
//console.log(mobileNavH5s);


let navboxIconMe = document.getElementsByClassName("nav-box-icon-me")[0];
navboxIconMe.addEventListener("mouseover", (evt) => {
    //navboxIconMe.src = "./imgs/menu/kaan.png";
})
navboxIconMe.addEventListener("mouseout", (evt) => {
    //navboxIconMe.src = "./imgs/menu/kaan-bw.png";
})
//console.log(navboxIconMe);
